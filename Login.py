...
#Kotak Background
layar1 = Tk()
layar1.geometry("1200x720")
layar1.title("Login")   

bg = ImageTk.PhotoImage(Image.open("gambarlogin.jpg"))
Label(layar1, image=bg).place(x=-0,y=0,relheight=1,relwidth=1)

kotak_log = Frame(layar1,bg="black")
kotak_log.place(x=400,y=60,height=330,width=400)
#------------------------------------------------------------------------------------------------#
#login system
def branded():
    username=nama1.get()
    ...
    if username=="zeta" and password=="daffa":
        #------------------------------------------------------------------------------------------------#
        #Kotak Background
        film1 = Toplevel(layar1)
        ...
        messagebox.showerror("Invalid","Username atau Password tidak sesuai")

#@----------------------------------------------------------------------------------------------@#
def daftar(): 
    layar2=Toplevel(layar1)
    layar2.geometry("1200x720")
    layar2.title("Daftar")

    bg = ImageTk.PhotoImage(Image.open("gambarlogin.jpg"))
    Label(layar2, image=bg).place(x=-0,y=0,relheight=1,relwidth=1)

    kotak_log = Frame(layar2,bg="black")
...
#------------------------------------------------------------------------------------------------#
#Pembuka
atas=Label(kotak_log,text="Login",fg="#57a1f8",bg="black",font=("Times New Roman",24,"bold"))
atas.place(x=150,y=30)
Frame(kotak_log,width=400,height=2,bg="#57a1f8").place(x=0,y=80)
Frame(kotak_log,width=400,height=2,bg="#57a1f8").place(x=0,y=270)
...
def on_leave(e):
    if nama1.get()=="":
        nama1.insert(0,"Username")

nama1= Entry(kotak_log,width=25,fg="white",bg="gray",font=("Times New Roman",11))
nama1.place(x=110,y=120)
nama1.insert(0,"Username")
nama1.bind("<FocusIn>",on_enter)
nama1.bind("<FocusOut>",on_leave)
...
def on_leave(e):
    if data1.get()=="":
        data1.insert(0,"Password")

data1= Entry(kotak_log,width=25,fg="white",bg="gray",font=("Times New Roman",11))
data1.place(x=110,y=150)
data1.insert(0,"Password")
data1.bind("<FocusIn>",on_enter)
data1.bind("<FocusOut>",on_leave)

#------------------------------------------------------------------------------------------------#
#Tombol signup
fara=Button(kotak_log,width=25,pady=7,text="Masuk",bg="red",fg="white",border=0,cursor="hand2",command=branded)
fara.place(x=110,y=200)

no_akun=Label(kotak_log,text="Belum punya akun?",fg="#57a1f8",bg="black",font=("Times New Roman",9))
no_akun.place(x=106,y=240)

klik_disini=Button(kotak_log,text="Daftar sekarang",bg="black",fg="#57a1f8",cursor="hand2",border=0,command=daftar)
klik_disini.place(x=206,y=240)
